...
BEGIN
    ...
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'FINANCE_&_AI_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-FINANCE_&_AI_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'DISCIPLINE_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-DISCIPLINE_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'DOCUMENTATION_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-DOCUMENTATION_HEAD';
    ...
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CREATIVE_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-CREATIVE_HEAD';
    ...
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'SOCIAL_MEDIA_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-SOCIAL_MEDIA_HEAD';
    ...
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'PHOTOGRAPHY_&_VIDEOGRAPHY_HEAD';
    ALTER TYPE member_position ADD VALUE IF NOT EXISTS 'CO-PHOTOGRAPHY_&_VIDEOGRAPHY_HEAD';
...
CREATE TABLE IF NOT EXISTS members (
    ...
    member_club_department VARCHAR, -- Options: TECHNICAL, FINANCE_&_AI, DISCIPLINE, DOCUMENTATION, EVENT_MANAGEMENT, CREATIVE, PROMOTION, SOCIAL_MEDIA, ANCHORING, PHOTOGRAPHY_&_VIDEOGRAPHY, ALL
